...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/sst/openpatent/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for sst/openpatent...\n")
...
console.log("Fetching npm all-time downloads for openpatent-ai...\n")
const npmDownloads = await fetchNpmDownloads("openpatent-ai")
