---
title: خوادم LSP
description: يتكامل OpenPatent مع خوادم LSP لديك.
---

يتكامل OpenPatent مع بروتوكول خادم اللغة (LSP) لمساعدة LLM على التفاعل مع قاعدة الشيفرة لديك. ويستخدم التشخيصات لتزويد LLM بتغذية راجعة.

---

## المدمجة

يأتي OpenPatent مع عدة خوادم LSP مدمجة للغات الشائعة:
...
عندما يفتح OpenPatent ملفا، فإنه:
...
يمكنك تخصيص خوادم LSP عبر قسم `lsp` في إعدادات OpenPatent.
