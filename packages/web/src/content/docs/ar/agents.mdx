...
يوجد نوعان من الوكلاء في OpenPatent: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي OpenPatent مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي OpenPatent مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي OpenPatent مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `OpenPatent.json`:
...
- عام: `~/.config/OpenPatent/agents/`
- لكل مشروع: `.OpenPatent/agents/`
...
إذا لم يتم تحديد temperature، يستخدم OpenPatent القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات OpenPatent العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات OpenPatent الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [OpenPatent Zen](/docs/zen)، فستستخدم `OpenPatent/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `OpenPatent models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/OpenPatent).
:::
