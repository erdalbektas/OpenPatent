---
title: دعم ACP
description: استخدم OpenPatent في أي محرر متوافق مع ACP.
---

يدعم OpenPatent بروتوكول [Agent Client Protocol](https://agentclientprotocol.com) أو (ACP)، مما يتيح لك استخدامه مباشرة في المحررات وبيئات التطوير المتكاملة (IDEs) المتوافقة.
...
لاستخدام OpenPatent عبر ACP، اضبط محررك ليشغّل الأمر `OpenPatent acp`.

يشغّل هذا الأمر OpenPatent كعملية فرعية متوافقة مع ACP تتواصل مع محررك عبر JSON-RPC باستخدام stdio.
...
لفتحه، اختر الوكيل الجديد 'OpenPatent' من محدد الوكلاء في AI Chat.
...
لاستخدام OpenPatent كوكيل ACP في [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim)، أضف التالي إلى إعدادات Neovim:
...
يضبط هذا الإعداد CodeCompanion لاستخدام OpenPatent كوكيل ACP للدردشة.
...
يعمل OpenPatent عبر ACP بالطريقة نفسها التي يعمل بها في terminal. جميع الميزات مدعومة:
...
- خوادم MCP المضبوطة في إعدادات OpenPatent
