...
- Global: `~/.config/openpatent/agent/`
- Per-project: `.openpatent/agent/`

```markdown title="~/.config/openpatent/agent/review.md"
---
...
:::tip
Do you have an agent you'd like to share? [Submit a PR](https://github.com/sst/openpatent).
:::
...
```markdown title="~/.config/openpatent/agent/docs-writer.md"
---
...
```markdown title="~/.config/openpatent/agent/security-auditor.md"
---
