---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala OpenPatent.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie OpenPatent uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI OpenPatent, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do OpenPatent. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij OpenPatent. _Aliasy_: `/quit`, `/q`
...
Możesz dostosować zachowanie TUI za pomocą pliku konfiguracyjnego OpenPatent.
