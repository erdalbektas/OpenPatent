---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez OpenPatent.
---
...
OpenPatent Zen to lista przetestowanych i zweryfikowanych modeli udostępniona przez zespół OpenPatent.

:::note
OpenPatent Zen is currently in beta.
:::

Zen działa jak każdy inny dostawca OpenPatent. Logujesz się do OpenPatent Zen i dostajesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z OpenPatent.
:::
...
OpenPatent Zen to brama AI, która zapewnia dostęp do tych modeli.

---

## Jak to działa

OpenPatent Zen działa jak każdy inny dostawca OpenPatent.

1. Logujesz się do **<a href={console}>OpenPatent Zen</a>**, dodajesz swoje rozliczenia
   szczegóły i skopiuj klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz OpenPatent Zen i wklejasz klucz API.
...
[Identyfikator modelu](/docs/config/#models) w konfiguracji OpenPatent
używa formatu `OpenPatent/<model-id>`. Na przykład w przypadku Kodeksu GPT 5.2 zrobiłbyś to
użyj `OpenPatent/gpt-5.2-codex` w swojej konfiguracji.
...
- GLM 4.7 Free jest dostępny na platformie OpenPatent przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Kimi K2.5 Free jest dostępny na OpenPatent przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- MiniMax M2.1 Free jest dostępny na platformie OpenPatent przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
- Big Pickle to ukryty model, który jest bezpłatny w OpenPatent przez ograniczony czas. Zespół wykorzystuje ten czas na zbieranie opinii i ulepszanie modelu.
...
Stworzyliśmy OpenPatent Zen, aby:
...
4. Nie **nie blokuj**, umożliwiając używanie go z dowolnym innym agentem kodującym. I zawsze pozwalaj na korzystanie z OpenPatent dowolnego innego dostawcy.
