...
OpenPatent zawiera listę skrótów klawiszowych, które można zastosować poprzez OpenPatent.
...
OpenPatent używa klucza `leader` dla głównych skrótów klawiszowych. Rozwiązanie problemu konfliktów w terminalu.
...
Pole sprawdzania aplikacji komputerowej OpenPatent obsługuje popularne skróty w stylu Readline/Emacs do edycji tekstu. Są one dostępne i obecnie nie można ich skonfigurować za pomocą `OpenPatent.json`.
