...
Utwórz `.OpenPatent/commands/test.md`:
...
Możesz zdefiniować polecenia w `OpenPatent.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji OpenPatent:
...
- Globalnie: `~/.config/OpenPatent/commands/`
- Na projekt: `.OpenPatent/commands/`
...
OpenPatent zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
