---
title: ACP-støtte
description: Bruk OpenPatent i en hvilken som helst ACP-kompatibel editor.
---

OpenPatent støtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), slik at du kan bruke den direkte i kompatible editorer og IDE-er.
...
For å bruke OpenPatent via ACP, konfigurer redigeringsprogrammet til å kjøre kommandoen `OpenPatent acp`.

Kommandoen starter OpenPatent som en ACP-kompatibel underprosess som kommuniserer med editoren din over JSON-RPC via stdio.
...
For å åpne den, bruk den nye 'OpenPatent'-agenten i AI Chat-agentvelgeren.
...
For å bruke OpenPatent som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), legg til følgende i Neovim-konfigurasjonen:
...
Denne konfigurasjonen setter opp CodeCompanion.nvim til å bruke OpenPatent som ACP-agent for chat.
...
OpenPatent fungerer på samme måte via ACP som i terminalen. Alle funksjoner støttes:
...
- MCP servere konfigurert i OpenPatent-konfigurasjonen
