---
title: TUI
description: Bruke OpenPatent-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre OpenPatent starter TUI for gjeldende katalog.
...
Når du bruker OpenPatent TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til OpenPatent. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt OpenPatent. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-oppførselen gjennom OpenPatent-konfigurasjonsfilen.
