---
title: Zen
description: Utvalgt liste over modeller levert av OpenPatent.
---
...
OpenPatent Zen er en liste over testede og verifiserte modeller levert av OpenPatent-teamet.

:::note
OpenPatent Zen er for øyeblikket i beta.
:::

Zen fungerer som alle andre leverandører i OpenPatent. Du logger på OpenPatent Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med OpenPatent.
:::
...
OpenPatent Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

OpenPatent Zen fungerer som alle andre leverandører i OpenPatent.

1. Du logger på **<a href={console}>OpenPatent Zen</a>**, legg til fakturering
   detaljer, og kopier API-nøkkelen.
2. Du kjører kommandoen `/connect` i TUI, velger OpenPatent Zen og limer inn API-nøkkelen.
...
[modell-id](/docs/config/#models) i OpenPatent-konfigurasjonen
bruker formatet `OpenPatent/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruk `OpenPatent/gpt-5.2-codex` i konfigurasjonen din.
...
- GLM 4.7 Free er tilgjengelig på OpenPatent i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Kimi K2.5 Free er tilgjengelig på OpenPatent i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- MiniMax M2.1 Free er tilgjengelig på OpenPatent i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på OpenPatent i en begrenset periode. Teamet bruker denne tiden til å samle tilbakemeldinger og forbedre modellen.
...
Vi opprettet OpenPatent Zen for å:
...
4. Ha **ingen låsing** ved å la deg bruke den med en hvilken som helst annen kodeagent. Og la deg alltid bruke en hvilken som helst annen leverandør med OpenPatent også.
