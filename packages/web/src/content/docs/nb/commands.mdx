...
Opprett `.OpenPatent/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom OpenPatent-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i OpenPatent [config](/docs/config):
...
- Per prosjekt: `.OpenPatent/commands/`
...
OpenPatent inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
