...
Agentferdigheter lar OpenPatent oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
OpenPatent søker etter disse stedene:

- Prosjektkonfigurasjon: `.OpenPatent/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/OpenPatent/skills/<name>/SKILL.md`
...
For prosjektlokale stier går OpenPatent opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.OpenPatent/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/OpenPatent/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.OpenPatent/skills/git-release/SKILL.md` slik:
...
OpenPatent viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `OpenPatent.json`:
...
**For innebygde agenter** (i `OpenPatent.json`):
