---
title: LSP-servere
description: OpenPatent integreres med LSP-serverne dine.
---

OpenPatent integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

OpenPatent kommer med flere innebygde LSP-servere for populære språk:
...
Når OpenPatent åpner en fil, gjør den:
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i OpenPatent-konfigurasjonen.
