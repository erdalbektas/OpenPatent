...
To debug any issues with openpatent, you can check the logs or the session data
...
- **Windows**: `%USERPROFILE%\.local\share\openpatent\log\`
...
- **Windows**: `%USERPROFILE%\.local\share\openpatent`
...
1. **Report issues on GitHub**
   ...
   [**github.com/sst/openpatent/issues**](https://github.com/sst/openpatent/issues)
