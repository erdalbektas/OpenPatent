...
Create `.openpatent/command/test.md`:

```md title=".openpatent/command/test.md"
---
...
You can add custom commands through the openpatent config or by creating markdown files in the `command/` directory.
...
- Global: `~/.config/openpatent/command/`
- Per-project: `.openpatent/command/`

```markdown title="~/.config/openpatent/command/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".openpatent/command/component.md"
---
...
```md title=".openpatent/command/create-file.md"
---
...
```md title=".openpatent/command/analyze-coverage.md"
---
...
```md title=".openpatent/command/review-changes.md"
---
...
```md title=".openpatent/command/review-component.md"
---
