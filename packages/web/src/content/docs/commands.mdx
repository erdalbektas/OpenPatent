...
Create `.OpenPatent/commands/test.md`:
...
You can add custom commands through the OpenPatent config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your OpenPatent [config](/docs/config):
...
- Per-project: `.OpenPatent/commands/`
...
OpenPatent includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
