...
Brug den til at bygge integrasjoner og kontrollere OpenPatent programmatisk.
...
Opret en forekomst av OpenPatent:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `OpenPatent.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av OpenPatent, kan du oprete en klientforekomst for at koble til den:
