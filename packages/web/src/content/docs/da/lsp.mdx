---
title: LSP-servere
description: OpenPatent integreres med dine LSP-servere.
---

OpenPatent integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

OpenPatent leveres med flere indbyggede LSP-servere til populære sprog:
...
Når OpenPatent åbner en fil, vil den:
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din OpenPatent-konfiguration.
