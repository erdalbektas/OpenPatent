...
description: Brug OpenPatent i enhver ACP-kompatibel editor.
---

OpenPatent understøtter [Agent Client Protocol](https://agentclientprotocol.com) eller (ACP), så du kan bruge det direkte i kompatible editorer og IDE'er.
...
For at bruge OpenPatent via ACP, konfigurer din editor til at køre kommandoen `OpenPatent acp`.

Kommandoen starter OpenPatent som en ACP-kompatibel underproces, der kommunikerer med din editor over JSON-RPC via stdio.
...
For at åbne den skal du bruge den nye 'OpenPatent'-agent i AI Chat-agentvælgeren.
...
For at bruge OpenPatent som en ACP-agent i [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), skal du tilføje følgende til din Neovim-konfiguration:
...
Denne konfiguration sætter CodeCompanion til at bruge OpenPatent som ACP-agent til chat.
...
OpenPatent fungerer på samme måde via ACP som i terminalen. Alle funktioner understøtter:
...
- MCP-servere konfigureret i din OpenPatent-konfiguration
