---
title: TUI
description: Brug af OpenPatent-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre OpenPatent starter TUI for den nuværende mappe.
...
Når du bruger OpenPatent TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til OpenPatent. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut OpenPatent. _Aliaser_: `/quit`, `/q`
...
Du kan tilpasse TUI-adfærden gennem OpenPatent-konfigurationsfilen.
