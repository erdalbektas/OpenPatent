---
title: Zen
description: Udvalgt liste over modeller leveret af OpenPatent.
---
...
OpenPatent Zen er en liste over testede og verificerede modeller leveret af OpenPatent-teamet.

:::note
OpenPatent Zen er i øjeblikket i beta.
:::

Zen fungerer som alle andre udbydere i OpenPatent. Du logger på OpenPatent Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, der fungerer godt med OpenPatent.
:::
...
OpenPatent Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

OpenPatent Zen fungerer som alle andre udbydere i OpenPatent.

1. Du logger på **<a href={console}>OpenPatent Zen</a>**, tilføjer faktureringsoplysninger
   og kopierer API-nøglen.
2. Du kører kommandoen `/connect` i TUI, vælger OpenPatent Zen og indsætter API-nøglen.
...
| Claude Sonnet 4.5   | claude-sonnett-4-5 | `https://OpenPatent.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4     | claude-sonnett-4   | `https://OpenPatent.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
...
| MiniMax M2.1 Gratis | minimax-m2.1-free  | `https://OpenPatent.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| GLM 4.7             | glm-4.7            | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 4.7 Gratis      | glm-4.7-free       | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
...
| Kimi K2.5 Gratis    | kimi-k2.5-free     | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2 Tenker      | kimi-k2-thinking   | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2             | kimi-k2            | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3-koder 480B    | qwen3-coder        | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Stor sylteagurk     | big-pickle         | `https://OpenPatent.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

[model-id](/docs/config/#models) i OpenPatent-konfigurationen
bruger formatet `OpenPatent/<model-id>`. For eksempel, for GPT 5.2 Codex, ville du
bruge `OpenPatent/gpt-5.2-codex` i din konfiguration.
...
- GLM 4.7 Gratis er tilgængelig på OpenPatent i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Kimi K2.5 Gratis er tilgængelig på OpenPatent i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- MiniMax M2.1 Gratis er tilgængelig på OpenPatent i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
- Stor sylteagurk er en stealth-model som er gratis på OpenPatent i en begrænset periode. Teamet bruger denne tid til at samle feedback og forbedre modellen.
...
Vi oprettede OpenPatent Zen for at:
...
4. Have **ingen fastlåsning** ved at lade dig bruge den med en hvilken som helst anden kodeagent. Og lade dig altid bruge en hvilken som helst anden udbyder med OpenPatent også.
