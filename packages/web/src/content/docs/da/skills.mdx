...
Agentferdigheter lar OpenPatent oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går OpenPatent opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
OpenPatent viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `OpenPatent.json`:
