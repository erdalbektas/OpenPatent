...
Der er to typer agenter i OpenPatent; primære agenter og subagenter.
...
OpenPatent leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
OpenPatent leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

OpenPatent leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `OpenPatent.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger OpenPatent modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale OpenPatent-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din OpenPatent-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [OpenPatent Zen](/docs/zen), vil du bruge `OpenPatent/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `OpenPatent models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/OpenPatent).
:::
