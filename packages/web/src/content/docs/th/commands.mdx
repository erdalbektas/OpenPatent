...
สร้าง `.OpenPatent/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ OpenPatent:
...
- ระดับผู้ใช้ (Global): `~/.config/OpenPatent/commands/`
- ระดับโปรเจ็กต์: `.OpenPatent/commands/`
...
OpenPatent มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
