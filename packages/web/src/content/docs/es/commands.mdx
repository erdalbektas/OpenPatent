...
Crear `.OpenPatent/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración OpenPatent o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su OpenPatent [config](/docs/config):
...
- Por proyecto: `.OpenPatent/commands/`
...
OpenPatent incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
