---
title: Zen
description: Lista seleccionada de modelos proporcionada por OpenPatent.
---
...
OpenPatent Zen es una lista de modelos probados y verificados proporcionada por el equipo OpenPatent.

:::note
OpenPatent Zen se encuentra actualmente en versión beta.
:::

Zen funciona como cualquier otro proveedor en OpenPatent. Inicias sesion en OpenPatent Zen y obtienes
tu API key. Es **completamente opcional** y no necesitas usarlo para usar OpenPatent.
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con OpenPatent.
:::
...
OpenPatent Zen es una puerta de enlace de IA que le brinda acceso a estos modelos.

---

## Cómo funciona

OpenPatent Zen funciona como cualquier otro proveedor en OpenPatent.

1. Inicias sesión en **<a href={console}>OpenPatent Zen</a>**, agregas tu facturación
   detalles y copie su clave API.
2. Ejecuta el comando `/connect` en TUI, selecciona OpenPatent Zen y pega tu clave API.
...
El [model ID](/docs/config/#models) en tu configuracion de OpenPatent
usa el formato `OpenPatent/<model-id>`. Por ejemplo, para GPT 5.2 Codex, debes
usar `OpenPatent/gpt-5.2-codex` en tu configuracion.
...
- GLM 4.7 Free está disponible en OpenPatent por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Kimi K2.5 Free está disponible en OpenPatent por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- MiniMax M2.1 Free está disponible en OpenPatent por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo sigiloso gratuito en OpenPatent por tiempo limitado. El equipo está aprovechando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. **No tener ningún bloqueo** al permitirle usarlo con cualquier otro agente de codificación. Y siempre le permitirá utilizar cualquier otro proveedor con OpenPatent también.
