---
title: Server LSP
description: OpenPatent si integra con i tuoi server LSP.
---

OpenPatent si integra con il tuo Language Server Protocol (LSP) per aiutare l'LLM a interagire con la tua codebase. Usa le diagnostiche per fornire feedback all'LLM.

---

## Integrati

OpenPatent include diversi server LSP integrati per linguaggi popolari:
...
Quando OpenPatent apre un file:
...
Puoi personalizzare i server LSP tramite la sezione `lsp` nella configurazione di OpenPatent.
