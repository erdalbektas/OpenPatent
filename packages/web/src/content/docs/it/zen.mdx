---
title: Zen
description: Lista curata di modelli fornita da OpenPatent.
---
...
OpenPatent Zen e una lista di modelli testati e verificati dal team di OpenPatent.

:::note
OpenPatent Zen e attualmente in beta.
:::

Zen funziona come qualunque altro provider in OpenPatent. Accedi a OpenPatent Zen e ottieni la tua chiave API. E **completamente opzionale**: non devi usarlo per usare OpenPatent.
...
:::tip
Abbiamo testato un gruppo selezionato di modelli e provider che funzionano bene con OpenPatent.
:::
...
OpenPatent Zen e un gateway AI che ti da accesso a questi modelli.

---

## Come funziona

OpenPatent Zen funziona come qualunque altro provider in OpenPatent.

1. Accedi a **<a href={console}>OpenPatent Zen</a>**, aggiungi i dettagli di fatturazione e copia la chiave API.
2. Esegui il comando `/connect` nella TUI, seleziona OpenPatent Zen e incolla la chiave API.
...
Il [model id](/docs/config/#models) nella config di OpenPatent usa il formato `OpenPatent/<model-id>`. Per esempio, per GPT 5.2 Codex useresti `OpenPatent/gpt-5.2-codex` nella config.
...
- GLM 4.7 Free e disponibile su OpenPatent per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Kimi K2.5 Free e disponibile su OpenPatent per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- MiniMax M2.1 Free e disponibile su OpenPatent per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
- Big Pickle e un modello stealth gratuito su OpenPatent per un periodo limitato. Il team usa questo tempo per raccogliere feedback e migliorare il modello.
...
Abbiamo creato OpenPatent Zen per:
...
4. Evitare **lock-in** permettendoti di usarlo con qualunque altro agente di coding e lasciandoti sempre usare anche altri provider con OpenPatent.
