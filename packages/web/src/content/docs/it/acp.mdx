---
title: Supporto ACP
description: Usa OpenPatent in qualunque editor compatibile con ACP.
---

OpenPatent supporta [Agent Client Protocol](https://agentclientprotocol.com) (ACP), permettendoti di usarlo direttamente in editor e IDE compatibili.
...
Per usare OpenPatent via ACP, configura l'editor in modo che esegua il comando `OpenPatent acp`.

Il comando avvia OpenPatent come sottoprocesso compatibile con ACP che comunica con l'editor via JSON-RPC su stdio.
...
Per aprirlo, seleziona il nuovo agente 'OpenPatent' nel selettore agenti di AI Chat.
...
Per usare OpenPatent come agente ACP in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), aggiungi quanto segue alla config di Neovim:
...
Questa config imposta CodeCompanion per usare OpenPatent come agente ACP per la chat.
...
OpenPatent funziona via ACP come nel terminale. Tutte le funzionalita sono supportate:
:::note
...
- Server MCP configurati nella tua configurazione OpenPatent
