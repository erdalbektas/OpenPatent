...
Crea `.OpenPatent/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di OpenPatent o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di OpenPatent:
...
- Globale: `~/.config/OpenPatent/commands/`
- Per progetto: `.OpenPatent/commands/`
...
OpenPatent include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
