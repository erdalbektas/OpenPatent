...
description: What's new in openpatent 1.0.
---

openpatent 1.0 is a complete rewrite of the TUI.
...
The new TUI works like the old one since it connects to the same openpatent server.
...
version. However some older versions of openpatent always grab latest.

To upgrade manually, run

```bash
$ openpatent upgrade 1.0.0
```

To downgrade back to 0.x, run

```bash
$ openpatent upgrade 0.15.31
```
