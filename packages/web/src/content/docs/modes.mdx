...
- Global: `~/.config/openpatent/mode/`
- Project: `.openpatent/mode/`

```markdown title="~/.config/openpatent/mode/review.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.1
tools:
...
Create mode files in `.openpatent/mode/` for project-specific modes or `~/.config/openpatent/mode/` for global modes:

```markdown title=".openpatent/mode/debug.md"
---
temperature: 0.1
tools:
  bash: true
...
```markdown title="~/.config/openpatent/mode/refactor.md"
---
model: anthropic/claude-sonnet-4-20250514
temperature: 0.2
tools:
