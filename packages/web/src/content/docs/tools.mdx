...
```markdown title="~/.config/openpatent/agent/readonly.md"
---
...
:::note
This tool is only available when `openpatent_EXPERIMENTAL_LSP_TOOL=true` (or `openpatent_EXPERIMENTAL=true`).
:::
