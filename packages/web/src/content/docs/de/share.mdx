---
title: Teilen
description: Teile OpenPatent-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu OpenPatent-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht OpenPatent Folgendes:
...
OpenPatent hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt OpenPatent den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`OpenPatent.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du OpenPatent in deiner Organisation einsetzt.
