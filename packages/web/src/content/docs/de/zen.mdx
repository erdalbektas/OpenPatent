---
title: Zen
description: Kuratierte Modellliste direkt von OpenPatent.
---
...
OpenPatent Zen ist eine vom OpenPatent-Team getestete und verifizierte Modellliste.

:::note
OpenPatent Zen befindet sich aktuell in der Beta.
:::

Zen funktioniert wie jeder andere Provider in OpenPatent.
Du meldest dich bei OpenPatent Zen an, holst dir deinen API-Key und nutzt ihn optional.
...
:::tip
Wir haben eine Auswahl aus Modellen und Providern getestet, die gut mit OpenPatent funktionieren.
:::
...
OpenPatent Zen ist ein AI-Gateway, das dir Zugriff auf genau diese Modelle gibt.

---

## Funktionsweise

OpenPatent Zen funktioniert wie jeder andere Provider in OpenPatent.

1. Melde dich bei **<a href={console}>OpenPatent Zen</a>** an, hinterlege Zahlungsdaten und kopiere deinen API-Key.
2. Fuehre in der TUI `/connect` aus, waehle OpenPatent Zen und fuege den API-Key ein.
...
Die [Model-ID](/docs/config/#models) in deiner OpenPatent-Konfiguration hat das Format `OpenPatent/<model-id>`.
Fuer GPT 5.2 Codex verwendest du zum Beispiel `OpenPatent/gpt-5.2-codex`.
...
Wir haben OpenPatent Zen entwickelt, um:
...
4. **Kein Lock-in** zu erzwingen, damit du Zen mit anderen Coding-Agents und OpenPatent weiter mit anderen Providern nutzen kannst
