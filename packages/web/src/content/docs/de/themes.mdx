...
Mit OpenPatent kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet OpenPatent das `OpenPatent`-Theme.
...
OpenPatent liefert mehrere eingebaute Themes mit.
...
- OpenPatent optisch ans Terminal anpassen wollen
...
OpenPatent unterstuetzt ein flexibles JSON-basiertes Theme-System.
