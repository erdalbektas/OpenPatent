---
title: TUI
description: Arbeite mit OpenPatent in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet OpenPatent die TUI im aktuellen Verzeichnis.
...
In der OpenPatent-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
You can customize TUI behavior through your OpenPatent config file.
