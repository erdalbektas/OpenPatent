...
Erstellen Sie `.OpenPatent/commands/test.md`:

```md title=".OpenPatent/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die OpenPatent-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem OpenPatent [config](/docs/config):

```json title="OpenPatent.jsonc" {4-12}
{
...
- Global: `~/.config/OpenPatent/commands/`
- Pro Projekt: `.OpenPatent/commands/`

```markdown title="~/.config/OpenPatent/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".OpenPatent/commands/component.md"
---
...
```md title=".OpenPatent/commands/create-file.md"
---
...
```md title=".OpenPatent/commands/analyze-coverage.md"
---
...
```md title=".OpenPatent/commands/review-changes.md"
---
...
```md title=".OpenPatent/commands/review-component.md"
---
...
OpenPatent enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
