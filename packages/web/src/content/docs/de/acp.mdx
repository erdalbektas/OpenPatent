...
description: Verwenden Sie OpenPatent in jedem ACP-kompatiblen Editor.
---

OpenPatent unterstützt [Agent Client Protocol](https://agentclientprotocol.com) oder (ACP), sodass Sie es direkt in kompatiblen Editoren und IDEs verwenden können.
...
Um OpenPatent über ACP zu verwenden, konfigurieren Sie Ihren Editor für die Ausführung des Befehls `OpenPatent acp`.

Der Befehl startet OpenPatent als ACP-kompatiblen Unterprozess, der über stdio über JSON-RPC mit Ihrem Editor kommuniziert.
...
Um es zu öffnen, verwenden Sie den neuen Agenten „OpenPatent“ in der AI Chat Agent Selector.
...
Um OpenPatent als ACP-Agent in [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim) zu verwenden, fügen Sie Folgendes zu Ihrer Neovim-Konfiguration hinzu:
...
Diese Konfiguration richtet CodeCompanion so ein, dass OpenPatent als ACP-Agent für den Chat verwendet wird.
...
OpenPatent funktioniert über ACP genauso wie im Terminal. Alle Funktionen werden unterstützt:
...
- MCP-Server, die in Ihrer OpenPatent-Konfiguration konfiguriert sind
