...
OpenPatent verfügt über eine Liste von Tastenkombinationen, die Sie über die OpenPatent-Konfiguration anpassen können.
...
OpenPatent verwendet für die meisten Keybinds einen `leader`-Schlüssel. Dies vermeidet Konflikte in Ihrem Terminal.
...
Die Eingabeaufforderungseingabe der OpenPatent-Desktop-App unterstützt gängige Readline/Emacs-style-Verknüpfungen zum Bearbeiten von Text. Diese sind integriert und derzeit nicht über `OpenPatent.json` konfigurierbar.
