---
title: TUI
description: Using the OpenPatent terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running OpenPatent starts the TUI for the current directory.
...
When using the OpenPatent TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to OpenPatent. Allows you to select from available providers and add their API keys.
...
Exit OpenPatent. _Aliases_: `/quit`, `/q`
...
This is separate from `OpenPatent.json`, which configures server/runtime behavior.
