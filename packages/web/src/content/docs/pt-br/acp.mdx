---
title: Suporte ACP
description: Use o OpenPatent em qualquer editor compatível com ACP.
---

O OpenPatent suporta o [Agent Client Protocol](https://agentclientprotocol.com) ou (ACP), permitindo que você o utilize diretamente em editores e IDEs compatíveis.
...
Para usar OpenPatent via ACP, configure seu editor para executar o comando `OpenPatent acp`.

Este comando inicia o OpenPatent como um subprocesso compatível com ACP que se comunica com seu editor via JSON-RPC através do stdio.
...
Para abri-lo, use o novo agente 'OpenPatent' no seletor de agentes do AI Chat.
...
Para usar OpenPatent como um agente ACP no [CodeCompanion.nvim](https://github.com/olimorris/codecompanion.nvim), adicione o seguinte à sua configuração do Neovim:
...
Esta configuração configura o CodeCompanion para usar OpenPatent como o agente ACP para chat.
...
O OpenPatent funciona da mesma forma via ACP como funciona no terminal. Todos os recursos são suportados:
...
- Servidores MCP configurados na sua configuração do OpenPatent
