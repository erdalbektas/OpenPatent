---
title: TUI
description: OpenPatent ターミナルユーザーインターフェイスの使用。
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent は、LLM を使用してプロジェクトを作業するための対話型ターミナルインターフェイスまたは TUI を提供します。

OpenPatent を実行すると、現在のディレクトリの TUI が開始されます。
...
OpenPatent TUI を使用する場合、「`/`」に続いてコマンド名を入力すると、アクションをすばやく実行できます。例えば：
...
OpenPatent にプロバイダーを追加します。利用可能なプロバイダーから選択し、その API キーを追加できます。
...
OpenPatent を終了します。 _エイリアス_: `/quit`、`/q`
...
OpenPatent 設定ファイルを通じて TUI の動作をカスタマイズできます。
