---
title: TUI
description: Korištenje korisničkog interfejsa OpenPatent terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje OpenPatent pokreće TUI za trenutni direktorij.
...
Kada koristite OpenPatent TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u OpenPatent. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz OpenPatent. _Aliases_: `/quit`, `/q`
...
Možete prilagoditi TUI ponašanje putem vašeg OpenPatent konfiguracionog fajla.
