...
Kreiraj `.OpenPatent/commands/test.md`:
...
Možete dodati prilagođene komande kroz OpenPatent konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom OpenPatent [config](/docs/config):
...
- Globalno: `~/.config/OpenPatent/commands/`
- Po projektu: `.OpenPatent/commands/`
...
OpenPatent uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
