---
title: Özel Araçlar
description: LLM'un OpenPatent'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. OpenPatent'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.OpenPatent/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/OpenPatent/tools/` içine yerleştirerek.
