...
description: OpenPatent, LSP sunucularınızla bütünleşir.
---

OpenPatent, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

OpenPatent, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
LSP sunucularını, OpenPatent yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
