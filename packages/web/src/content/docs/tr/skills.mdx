...
Ajan becerileri, OpenPatent'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
OpenPatent su konumlari tarar:

- Proje konfigurasyonu: `.OpenPatent/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/OpenPatent/skills/<name>/SKILL.md`
...
Proje yerel yollarinda OpenPatent, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.OpenPatent/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/OpenPatent/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.OpenPatent/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
OpenPatent, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`OpenPatent.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`OpenPatent.json` icinde):
