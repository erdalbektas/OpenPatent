---
title: TUI
description: OpenPatent terminal arayuzunu kullanin.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

OpenPatent, projelerinizde LLM ile calismak icin etkilesimli bir terminal arayuzu (TUI) sunar.

OpenPatent'u calistirdiginizda mevcut dizin icin TUI baslar.
...
OpenPatent TUI kullanirken `/` ve komut adini yazarak hizli eylemler calistirabilirsiniz. Ornek:
...
OpenPatent'a bir provider ekler. Mevcut provider'lari secip API anahtarlari eklemenizi saglar.
...
OpenPatent'dan cikar. _Takma adlar_: `/quit`, `/q`
...
TUI davranisini OpenPatent config dosyanizdan ozellestirebilirsiniz.
