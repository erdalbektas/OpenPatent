...
`.OpenPatent/commands/test.md` oluştur:
...
OpenPatent işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

OpenPatent [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/OpenPatent/commands/`
- Proje başına: `.OpenPatent/commands/`
...
OpenPatent, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
