---
title: Paylasim
description: OpenPatent konusmalarini genel baglantilarla paylasin.
---

OpenPatent'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda OpenPatent:
...
OpenPatent, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak OpenPatent manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `OpenPatent.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda OpenPatent kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
