...
description: OpenPatent dile özgü biçimlendiriciler kullanır.
---

OpenPatent, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

OpenPatent, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, OpenPatent bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

OpenPatent bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri OpenPatent yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
