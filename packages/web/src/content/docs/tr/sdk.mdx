---
title: SDK
description: OpenPatent sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

OpenPatent JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
OpenPatent'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir OpenPatent örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `OpenPatent.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir OpenPatent örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
