...
export default function TermsOfService() {
  return (
    <main data-page="legal">
      <Title>openpatent | Terms of Service</Title>
      <Link rel="canonical" href={`${config.baseUrl}/legal/terms-of-service`} />
      <Meta name="description" content="openpatent terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to openpatent. Please read on to learn the rules and restrictions that govern your use of openpatent
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("openpatent," "we" and "us"). Your use of the Services in any
                ...
                <a href="/legal/privacy-policy">https://openpatent.ai/legal/privacy-policy</a>.{" "}
                <strong>
              ...
              <h2 id="what-is-openpatent">What is openpatent?</h2>
              <p>
                openpatent is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the openpatent Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, openpatent enables you to
              ...
              <p>
                ...
                our site located at openpatent.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                openpatent takes the privacy of its users very seriously. For the current openpatent Privacy Policy, please
                click here{" "}
                <a href="https://openpatent.ai/legal/privacy-policy">https://openpatent.ai/legal/privacy-policy</a>.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using openpatent?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by openpatent;
                </li>
                <li>
              ...
              <p>
                If you use openpatent with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                openpatent. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                openpatent has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-openpatent-ever-change-the-services">Will openpatent ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                Services"). Please see our Paid Services page <a href="/zen">https://openpatent.ai/zen</a> for a
              ...
              <p>
                ...
                <a href="https://openpatent.ai/auth">https://openpatent.ai/auth</a>.
              </p>
              ...
              <p>
                ...
                <a href="/legal/privacy-policy">https://openpatent.ai/legal/privacy-policy</a>, as well as the licenses
                above, to understand how we treat information you provide to us after you have stopped using our
                Services.
              </p>

              <p>
                openpatent is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. openpatent has the sole right to decide whether you are
              ...
              <p>
                openpatent and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (openpatent and all such
                parties together, the "openpatent Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the openpatent Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The openpatent Parties make no representations or warranties regarding
                suggestions or recommendations of services or products offered or purchased through or in connection
                with the Services. THE SERVICES AND CONTENT ARE PROVIDED BY openpatent (AND ITS LICENSORS AND SUPPLIERS)
              ...
              <p>
                ...
                openpatent PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT, SPECIAL, INCIDENTAL,
                ...
                TO openpatent IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the openpatent Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without openpatent's prior written
              ...
              <p>
                ...
                disputes and claims with openpatent and limits the manner in which you can seek relief from openpatent. Both
                you and openpatent acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, openpatent's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. openpatent will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. openpatent will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or openpatent may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND openpatent WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
                OF A JUDGE OR JURY. You and openpatent are instead choosing to have claims and disputes resolved by
                ...
                you and openpatent over whether to vacate or enforce an arbitration award, YOU AND openpatent WAIVE ALL
              ...
              <p>
                ...
                openpatent is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or openpatent to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and openpatent agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the openpatent may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and openpatent agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and openpatent, and
                ...
                are not an employee, agent, partner, or joint venture of openpatent, and you do not have any authority of
                any kind to bind openpatent in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and openpatent
