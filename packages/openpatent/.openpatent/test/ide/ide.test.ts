...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders openpatent_CALLER", () => {
    process.env["openpatent_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode openpatent_CALLER", () => {
    process.env["openpatent_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown openpatent_CALLER", () => {
    process.env["openpatent_CALLER"] = "unknown"
