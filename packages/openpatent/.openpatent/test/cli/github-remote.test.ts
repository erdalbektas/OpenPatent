...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openpatent.git")).toEqual({ owner: "sst", repo: "openpatent" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/openpatent")).toEqual({ owner: "sst", repo: "openpatent" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openpatent.git")).toEqual({ owner: "sst", repo: "openpatent" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/openpatent")).toEqual({ owner: "sst", repo: "openpatent" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openpatent.git")).toEqual({ owner: "sst", repo: "openpatent" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/openpatent")).toEqual({ owner: "sst", repo: "openpatent" })
})
