export const TIPS = [
  ...
  "Use {highlight}/undo{/highlight} to revert the last message and any file changes made by openpatent.",
  "Use {highlight}/redo{/highlight} to restore previously undone messages and file changes.",
  "Run {highlight}/share{/highlight} to create a public link to your conversation at openpatent.ai.",
  ...
  "Create {highlight}openpatent.json{/highlight} in project root for project-specific settings.",
  "Place settings in {highlight}~/.config/openpatent/openpatent.json{/highlight} for global config.",
  ...
  "openpatent auto-handles OAuth for remote MCP servers requiring auth.",
  "Add {highlight}.md{/highlight} files to {highlight}.openpatent/command/{/highlight} to define reusable custom prompts.",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input.",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight}).",
  "Add {highlight}.md{/highlight} files to {highlight}.openpatent/agent/{/highlight} for specialized AI personas.",
  "Configure per-agent permissions for {highlight}edit{/highlight}, {highlight}bash{/highlight}, and {highlight}webfetch{/highlight} tools.",
  'Use patterns like {highlight}"git *": "allow"{/highlight} for granular bash permissions.',
  'Set {highlight}"rm -rf *": "deny"{/highlight} to block destructive commands.',
  'Configure {highlight}"git push": "ask"{/highlight} to require approval before pushing.',
  "openpatent auto-formats files using prettier, gofmt, ruff, and more.",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting.',
  "Define custom formatter commands with file extensions in config.",
  "openpatent uses LSP servers for intelligent code analysis.",
  "Create {highlight}.ts{/highlight} files in {highlight}.openpatent/tool/{/highlight} to define new LLM tools.",
  "Tool definitions can invoke scripts written in Python, Go, etc.",
  "Add {highlight}.ts{/highlight} files to {highlight}.openpatent/plugin/{/highlight} for event hooks.",
  "Use plugins to send OS notifications when sessions complete.",
  "Create a plugin to prevent openpatent from reading sensitive files.",
  "Use {highlight}openpatent run{/highlight} for non-interactive scripting.",
  "Use {highlight}openpatent run --continue{/highlight} to resume the last session.",
  "Use {highlight}openpatent run -f file.ts{/highlight} to attach files via CLI.",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts.",
  "Run {highlight}openpatent serve{/highlight} for headless API access to openpatent.",
  "Use {highlight}openpatent run --attach{/highlight} to connect to a running server for faster runs.",
  "Run {highlight}openpatent upgrade{/highlight} to update to the latest version.",
  "Run {highlight}openpatent auth list{/highlight} to see all configured providers.",
  "Run {highlight}openpatent agent create{/highlight} for guided agent creation.",
  "Use {highlight}/openpatent{/highlight} in GitHub issues/PRs to trigger AI actions.",
  "Run {highlight}openpatent github install{/highlight} to set up the GitHub workflow.",
  "Comment {highlight}/openpatent fix this{/highlight} on issues to auto-create PRs.",
  "Comment {highlight}/oc{/highlight} on PR code lines for targeted code reviews.",
  'Use {highlight}"theme": "system"{/highlight} to match your terminal\'s colors.',
  "Create JSON theme files in {highlight}.openpatent/themes/{/highlight} directory.",
  ...
  "Run {highlight}openpatent debug config{/highlight} to troubleshoot configuration.",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/sst/openpatent{/highlight} for containerized use.",
  "Use {highlight}/connect{/highlight} with openpatent Zen for curated, tested models.",
