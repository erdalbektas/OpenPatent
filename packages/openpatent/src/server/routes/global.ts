  ...
  new Hono()
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global OpenPatent configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global OpenPatent configuration settings and preferences.",
