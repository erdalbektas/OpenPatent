...
beforeAll(async () => {
  ...
  mock.module("@openpatent/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@openpatent/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@openpatent/ui/icon", () => ({ Icon: () => null }))
  mock.module("@openpatent/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
