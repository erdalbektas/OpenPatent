...
import type {
  ...
  McpRemoteConfig,
  McpStatusResponses,
  OpenpatentStatusResponses,
  OpenpatentUsageResponses,
  OpenpatentValidateResponses,
  OutputFormat,
  Part as Part2,
  PartDeleteErrors,
  PartDeleteResponses,
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global OpenPatent configuration settings and preferences.
   */
   ...
   *
   * Update global OpenPatent configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the OpenPatent server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the OpenPatent system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all OpenPatent instances, releasing all resources.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with OpenPatent.
   */
   ...
   * Get current project
   *
   * Retrieve the currently active project that OpenPatent is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by OpenPatent.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current OpenPatent configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update OpenPatent configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all OpenPatent sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new OpenPatent session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific OpenPatent session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Openpatent extends HeyApiClient {
  /**
   * Validate token
   *
   * Validate an OpenPatent JWT token
   */
  public validate<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).post<OpenpatentValidateResponses, unknown, ThrowOnError>({
      url: "/openpatent/validate",
      ...options,
      ...params,
    })
  }
   ...
   *
   * Get the current OpenPatent authentication status
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).get<OpenpatentStatusResponses, unknown, ThrowOnError>({
      url: "/openpatent/status",
      ...options,
      ...params,
    })
  }
   ...
   * Record usage
   *
   * Record usage for tracking daily active users
   */
  public usage<ThrowOnError extends boolean = false>(
    ...
    const params = buildClientParams([parameters], [{ args: [{ in: "query", key: "directory" }] }])
    return (options?.client ?? this.client).post<OpenpatentUsageResponses, unknown, ThrowOnError>({
      url: "/openpatent/usage",
      ...options,
      ...params,
    })
  }
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current OpenPatent instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the OpenPatent system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the OpenPatent system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the OpenPatent system.
   */
...
export class OpencodeClient extends HeyApiClient {
  ...
  private _openpatent?: Openpatent
  get openpatent(): Openpatent {
    return (this._openpatent ??= new Openpatent({ client: this.client }))
  }
