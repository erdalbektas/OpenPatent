...
export type Config = {
  ...
  server?: ServerConfig
  /**
   * Command configuration, see https://openpatent.ai/docs/commands
   */
  command?: {
    [key: string]: {
      template: string
  ...
  /**
   * Agent configuration, see https://openpatent.ai/docs/agents
   */
  agent?: {
    plan?: AgentConfig
    build?: AgentConfig
  ...
  openpatent?: {
    /**
     * OpenPatent API key for authentication
     */
    apiKey?: string
    /**
     * Enable OpenPatent platform features
     */
    enabled?: boolean
  }
}
...
export type OpenpatentValidateData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type OpenpatentValidateResponses = {
  /**
   * Validation result
   */
  200: {
...
export type OpenpatentValidateResponse = OpenpatentValidateResponses[keyof OpenpatentValidateResponses]

export type OpenpatentStatusData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type OpenpatentStatusResponses = {
  /**
...
export type OpenpatentStatusResponse = OpenpatentStatusResponses[keyof OpenpatentStatusResponses]

export type OpenpatentUsageData = {
  body?: never
  path?: never
  query?: {
    directory?: string
...
export type OpenpatentUsageResponses = {
  /**
   * Usage recorded
   */
  200: {
...
export type OpenpatentUsageResponse = OpenpatentUsageResponses[keyof OpenpatentUsageResponses]
